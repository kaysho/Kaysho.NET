        ...
        private async void ExecuteLogin()
        {
            ...
            if (current == NetworkAccess.Internet)
            {
                ...
                if (!authenticationResponse.IsVerified)
                {
                    ...
                    _settingsService.UserIdSetting = authenticationResponse.Id;
                    //_settingsService.UserTokenSetting = authenticationResponse.Token;
                    _settingsService.UserNameSetting = authenticationResponse.Name;
